...
#define SMARTBEE_MQTT_SERVER "broker.emqx.io"   // direccion IP del servidor MQTT (o websocket)
#define SMARTBEE_MQTT_PORT SMARTBEE_MQTT_NML // seleccionar SMARTBEE_MQTT_NML, SMARTBEE_MQTT_TLS o SMARTBEE_MQTT_WSS
...
#define SMARTBEE_LOADCELL_CALIBRATION 23.25 // resultado de la calibración
// --- FIN CONFIGURACION ---

#define SMARTBEE_MQTT_CLIENTID SMARTBEE_MQTT_NODE                        // id unico de este nodo
#define SMARTBEE_MQTT_TOPIC "testtopic/smartbee" // topico en donde publicar
